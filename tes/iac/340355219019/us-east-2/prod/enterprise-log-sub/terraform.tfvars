...
cloudwatch_log_group_name = "prod-208604-terratattle" # the name of the log group that will be subscribed to the log exporter
...
splunk_index  = "cloud_apps_prod" # Either (cloud_apps_nonprod|cloud_apps_prod) based on environment, it the splunk index to which the logs will be sent
